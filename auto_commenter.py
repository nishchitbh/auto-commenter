...
def directory_commenter(root_dir):
    ...
    for entry in entries:
        ...
        if os.path.isdir(path):
            ...
            # If the file extension is in the list of code extensions, process the file
...
def main():
    ...
    # If a directory is specified, comment the code in all files in the directory.
    if not single_file:
        ...
        commented = commenter(content)
        # Remove the initial and final markdown from the commented code
